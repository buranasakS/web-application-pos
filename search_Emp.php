...
$sql_data = "SELECT * FROM employee 
               WHERE `Emp_name` LIKE '%$search_text%'  
               OR Emp_id  LIKE '%$search_text%' OR Major_id  LIKE  '%$search_text%' ";
//echo $sql_data;
    ...
    <div class="d-flex flex-row bd-highlight mb-3 box_content">
        ...
        <div class="p-2 bd-highlight" id="side_right">
            ...
            <div class="input-group mb-3 btt_search">
                <input type="text" name="search" class="form-control" placeholder="ค้นหาชื่อรหัส/ชื่อสินค้า" aria-label="Recipient's username" aria-describedby="button-addon2">
                <button class="btn btn-outline-secondary" type="button" id="btt_search">ค้นหา</button>
                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                    ...
                    <form class="modal-content" method="post" action="add_product.php">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label class="form-label">ตำแหน่งพนักงาน</label>
                                        ...
                                        <div class="modal fade" id="edit_modal<?php echo $row['Emp_id']; ?>" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                                ...
                                                <form class="modal-content" method="post" action="formEdit.php">
                                                    ...
                                                    <div class="mb-3">
                                                        <label class="form-label">รหัสพนักงาน</label>
                                                        <input type="text" class="form-control" name="P_id" value="<?php echo $row['Emp_id']; ?>" readonly />
                                                    </div>


                                                    <div class="mb-3">
                                                        <label class="form-label">ชื่อพนักงาน</label>
                                                        <input type="text" class="form-control" name="P_name" value="<?php echo $row['Emp_name']; ?>" />
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" id="inputGroupSelect01" name="Emptype">
