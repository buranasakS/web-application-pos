...
<body>
  ...
  <div class="d-flex flex-row bd-highlight mb-3 box_content">
    ...
    <div class="p-2 bd-highlight" id="side_left">
      ...
      <p class="name_admin">ยินดีต้อนรับ <?php echo $user ?></p>
      ...
      <div class="d-flex flex-column bd-highlight mb-3 flex_menu">
        ...
        <div class="p-2 bd-highlight btn_1">
          <button type="button" class="btn btn-secondary btn-lg btn_sideleft"><a href="sales.php">ขายสินค้า</button>
    ...
    <div class="p-2 bd-highlight" id="side_right">
      ...
      <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#add_ฺBrand">เพิ่มแบรนด์สินค้า</button>
      <div class="modal fade" id="add_ฺBrand" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          ...
          <form class="modal-content" method="post" action="add_Brand.php">
            ...
            <div class="modal-body">
              ...
              <div class="mb-3">
                <label class="form-label">รหัสแบรนด์</label>
                <input type="text" class="form-control" name="B_id" required />
              </div>
              <div class="mb-3">
